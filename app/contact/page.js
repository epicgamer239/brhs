      ...
      <div className="relative min-h-[28vh] flex flex-col justify-center px-6 py-12 lg:py-16 lg:px-8 xl:px-12 overflow-hidden -mt-6">
        ...
        <div className="relative z-10 max-w-4xl mx-auto w-full">
          ...
          <p className="mt-3 text-lg text-muted-foreground">
            Reach out for questions about our tools, the club, or feedback.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="text-muted-foreground space-y-1 list-disc list-inside">
                <li>Questions about our tools (grade calculator, seating chart, yearbook formatting)</li>
                <li>Club inquiries and partnership with Broad Run</li>
                <li>Feedback or ideas for new tools</li>
                <li>General support and technical questions</li>
              </ul>
            </div>
          </div>
          <p className="mt-10 text-sm text-muted-foreground">
            <strong className="text-foreground">Shail Shah, Aryan Kothari, and Pranav Natarajan</strong> are students at Broad Run High School and the executive board of the Code4Community club. They run this site and are the point of contact for any inquiries.
          </p>
        </div>
      </div>
